...
class EventControllerTest {
    ...
    void createEvent_validationError_subjectIsNull() throws Exception {
        EventDto eventDto = new EventDto(1l,null, LocalDate.now());
    ...
    void createEvent_validationError_eventDtIsNull() throws Exception {
        EventDto eventDto = new EventDto(1l,"Spring study", null);
    ...
    void createEvent_validationError_eventDt_previousDate() throws Exception {
        EventDto eventDto = new EventDto(1l,"Spring study", LocalDate.now().minusDays(10));
    ...
    void updateEvent() throws Exception {
        EventDto eventDto = new EventDto(1l,"spring study", LocalDate.now());
        when(eventService.update(anyLong(),any())).thenReturn(1l);
